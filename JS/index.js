...
fetch(
  "https://api.giphy.com/v1/gifs/translate?api_key=8SqL9qrrx5SB81E84CQ5S8dJMLft9VRf&s=cat",
  { mode: "cors" }
)
...
async function getGithubRepo() {
  try {
    const response = await fetch(
      "https://api.github.com/users/sarross88/repos"
    );
...
// console.log(
//   getLastSection("https://github.com/sarross88/sarah-dapkiewicz-haumea")
// );
